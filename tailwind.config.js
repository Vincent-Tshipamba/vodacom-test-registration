...
export default {
    ...
    plugins: [
        ...
        require('./public/plugins/headings.js'),
        require('./public/plugins/buttons.js'),
        require('./public/plugins/card.js'),
        //third party libraries
        require('./public/plugins/simplebar.js'),
        require('./public/plugins/colorpicker.js'),
        require('./public/plugins/apexcharts.js'),
        require('./public/plugins/scroll-hint.js'),
        require('./public/plugins/fullcalendar.js'),
        require('./public/plugins/vanilla-calendar.js'),
        //apps pages
        require('./public/plugins/apps.js'),
    ],
};
