<x-app-layout>
    ...
    <div class="h-full bg-slate-100 dark:bg-slate-900 text-slate-900 dark:text-slate-300">
        <div x-data="app()" x-cloak>
            <div class="max-w-3xl mx-auto px-4 py-10">
                <div x-show.transition="step === 'complete'">
                    <div class="bg-slate-300 dark:bg-slate-900 rounded-lg p-10 flex items-center shadow justify-between">
                        <div>
                ...
                <div x-show.transition="step != 'complete'">
                    ...
                    <div class="border-b-2 py-3">
                        <div>{{ __('registration.step') }} <span x-text="step"></span> {{ __('registration.of') }} 3
                        </div>
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                            ...
                            <div class="flex items-center md:w-64">
                                ...
                                <div class="text-xs w-10" x-text="parseInt(step / 3 * 100) +'%'"></div>
                            </div>
                        </div>
                    </div>
                    <!-- /Top Navigation -->
                    ...
                    <div class="py-16">
                        <div x-show.transition.in="step === 1">
                            <div class="mb-5 text-center">
                                ...
                                <label for="photo" type="button"
                                    class="cursor-pointer inine-flex justify-between items-center focus:outline-none border py-2 px-4 rounded-lg shadow-sm text-left text-gray-600 bg-white dark:bg-slate-800 dark:text-slate-300 hover:bg-gray-100 dark:hover:bg-slate-700 font-medium">
                            ...
                            <div class="mb-5">
                                <label for="firstname"
                                    class="font-bold mb-1 block">{{ __('registration.input_firstname_label') }}</label>
                                <input type="text" id="firstname"
                                    class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 dark:text-slate-300 dark:bg-slate-900 font-medium"
                                    placeholder="{{ __('registration.input_firstname_placeholder') }}">
                            </div>
                            <div class="mb-5">
                                <label for="lastname"
                                    class="font-bold mb-1 block">{{ __('registration.input_lastname_label') }}</label>
                            ...
                            <div class="mb-5">
                                <label for="phone"
                                    class="font-bold mb-1 block">{{ __('registration.input_phone_label') }}</label>
                                <div class="relative mt-2">
                                    <div class="absolute top-3 left-0 flex items-center pl-3">
                                        <button id="dropdownButton"
                                            class="h-full text-sm flex justify-center items-center text-gray-600 dark:text-slate-300 dark:bg-slate-900  focus:outline-none">
                                            <span id="dropdownSpan">+243</span>
                                    ...
                                    <input type="number" id="phone"
                                        class="w-full pl-20 px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 dark:text-slate-300 dark:bg-slate-900 font-medium"
                                        placeholder="824-456-323" />
                                </div>
                            </div>
                            <div class="mb-5">
                                <label for="email"
                                    class="font-bold mb-1 block">{{ __('registration.input_email_label') }}</label>
                                <input type="email" id="email"
                                    class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 dark:text-slate-300 dark:bg-slate-900 font-medium"
                                    placeholder="{{ __('registration.input_email_placeholder') }}">
                            </div>

                        </div>
                        <div x-show.transition.in="step === 2">
                            <div class="mb-5">
                                <label for="password" class="font-bold mb-1 block">Set up password</label>
                        ...
                        <div x-show.transition.in="step === 3">
                            <div class="mb-5">
                                <label for="email" class="font-bold mb-1 block">Gender</label>
                                ...
                                <div class="flex">
                                    <label
                                        ...
                                        <div class="select-none">Male</div>
                                    </label>
                                    ...
                                    <label
                                        ...
                                        <div class="select-none">Female</div>
                                    </label>
                                </div>
                            </div>

                            <div class="mb-5">
                                <label for="profession" class="font-bold mb-1 block">Profession</label>
