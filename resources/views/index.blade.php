<x-app-layout>
    ...
    @section('script')
        <script>
            // Récupération des données de témoignages depuis les fichiers de traduction
            const testimonialsData = @json(__('testimonials.items'));

            // Mappage des données avec les images
            const cardsData = testimonialsData.map((testimonial, index) => ({
                ...
                ][index % 4], // Utilisation d'images différentes pour chaque témoignage
