@foreach ($applicants as $candidat)
        <div class="card cursor-pointer hover:bg-gray-200 dark:hover:bg-zinc-900"
            onclick="if (event.target.closest('a, button, .dropdown, .dropdown-menu, input, select, textarea, label')) return; window.location.href='{{ route('admin.applicants.show', ['locale' => app()->getLocale(), 'applicant' => $candidat->id]) }}'">
            <div class="card-body">
                <div
