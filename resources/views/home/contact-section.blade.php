<section id="contact" class="site-section-surface py-16 sm:py-20">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-16 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                <div class="rounded-2xl bg-gray-50 dark:bg-gray-800 p-6 text-center">
                    <div
                        class="animate-bounce mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-red-100 dark:bg-red-900/50">
