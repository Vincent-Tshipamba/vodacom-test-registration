<section id="what-is-it" class="site-section-surface py-16">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                @foreach (__('what-is-it.cards') as $card)
                    <div
                        class="bg-white dark:bg-gray-900 rounded-2xl shadow-lg shadow-slate-900/10 dark:shadow-slate-800 p-6 text-center hover:scale-110 transition-all duration-300">
