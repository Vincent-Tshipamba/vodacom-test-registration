<section>
    ...
    <form method="post" action="{{ route('profile.update', app()->getLocale()) }}" class="space-y-6 mt-6">
        @csrf
        @method('patch')
            ...
            @if ($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail())
                <div>
                    <p class="mt-2 text-gray-800 text-sm">
                        ...
                        <button form="send-verification" class="rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 text-gray-600 hover:text-gray-900 text-sm underline">
